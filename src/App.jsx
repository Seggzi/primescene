    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="relative z-10 -mt-32 md:-mt-48 pb-20">
        <div className="bg-black/80 backdrop-blur-sm pt-8">
          <section className="relative z-20 pt-8 md:pt-12 pb-20">
            <div className="px-4 md:px-8 lg:px-12 -mt-0">  {/* No negative margin */}
              <Row title="Trending Now" fetchUrl={`${base}/trending/all/week?api_key=${API_KEY}`} />
              {/* <Row title="Africa movies" fetchUrl={`${base}/movie/africa/week?api_key=${API_KEY}`} /> */}
