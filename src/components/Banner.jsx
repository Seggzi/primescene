...
function Banner() {
    ...
    return (
        <div
            className="relative h-[60vh] md:h-[80vh] flex items-end"
            style={{
        ...
        >
            {/* Stronger dark gradients for text readability */}
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent"></div>
            <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-transparent to-transparent"></div>

            <div className="relative z-20 pb-12 px-8 md:px-12 max-w-3xl">
                <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 drop-shadow-2xl">
                    {movie.title || movie.name}
                </h1>
                <p className="text-lg md:text-2xl text-white mb-8 max-w-2xl line-clamp-4 drop-shadow-xl">
